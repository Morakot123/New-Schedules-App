// pages/admin/grades.js
import { getSession, useSession } from 'next-auth/react';
import { useState, useEffect } from 'react';
// ไม่ต้อง import Layout ที่นี่ เพราะ _app.js จัดการ Layout หลักแล้ว
import ManageGradesForm from '../../components/ManageGradesForm'; // ตรวจสอบ Path ให้ถูกต้อง
...
export default function AdminGradesPage() {
    ...
    // ฟังก์ชันสำหรับรีเฟรชข้อมูลหรือแสดงข้อความสำเร็จหลังจาก ManageGradesForm อัปเดตข้อมูล
    const handleGradeUpdate = () => {
        // คุณสามารถเพิ่ม logic เช่น แสดงข้อความสำเร็จ หรือรีเฟรชข้อมูลอื่นๆ ที่เกี่ยวข้อง
        // setAlertMessage("ข้อมูลระดับชั้นอัปเดตแล้ว");
    ...
    return (
        ...
        <div className="main-content-container p-6 bg-gray-100 dark:bg-gray-800 min-h-screen">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <ManageGradesForm onGradeUpdate={handleGradeUpdate} />
            </div>
        </div>
    );
}
