    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(data.message || 'เกิดข้อผิดพลาดในการสร้างห้องปฏิบัติการ')
            }

            // Show success alert and redirect
            setAlertType('success')
            setAlertMessage('✅ สร้างห้องปฏิบัติการใหม่สำเร็จ! กำลังนำทางกลับ...')
            setTimeout(() => {
                    ...
                    <form onSubmit={handleSubmit} className="form-box animate-fade-in-up">
                        <div className="form-group mb-6">
                            ...
                            <input
                                ...
                                placeholder="เช่น LAB 101, ห้องปฏิบัติการเคมี"
                                required
                            />
                        </div>
