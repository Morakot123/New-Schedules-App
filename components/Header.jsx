...
export default function Header() {
    ...
    return (
        <header className="bg-white text-gray-800 shadow-md transition-colors duration-300 dark:bg-gray-900 dark:text-white">
            <nav className="container mx-auto flex items-center justify-between p-4">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* <select className="bg-transparent text-gray-800 dark:text-white">
